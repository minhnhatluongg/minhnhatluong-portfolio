/**
 * HighlightText - Joly UI (https://jolyui.dev/docs/components/text-animations/highlight-text)
 *
 * Vẽ hiệu ứng highlight kiểu tay vẽ (underline / box / circle / marker)
 * quanh đoạn text khi scroll vào viewport.
 * Đã bỏ cva - nhận trực tiếp prop `color` là mã màu CSS.
 */
import { forwardRef, useEffect, useRef, useState } from "react";
import { cn } from "../../../lib/utils";

const HighlightText = forwardRef(
  (
    {
      className,
      variant = "underline",

/**
 * Contact Section Component - ⭐⭐ Trung Bình
 *
 * Component hiển thị thông tin liên hệ và social media links
 *
 * MINDSET:
 * 1. Organize data trong array (dễ maintain)
 * 2. Sử dụng reusable SocialLink component
 * 3. SVG icons inline (để customize màu)
 * 4. Grid layout responsive
 *
 * Học được:
 *   - Data organization với objects
...
export const Contact = () => {
  // STEP 1: Organize social links data
  // Mỗi platform có icon, link, label, và màu riêng
  const socialLinks = [
    {
      label: "Email",
    ...
    // {
    //   label: "LinkedIn",
    //   href: "https://linkedin.com/in/yourprofile", // ← Thay LinkedIn profile
    ...
    // {
    //   label: "Twitter",
    //   href: "https://twitter.com/yourprofile", // ← Thay Twitter username
      ...
      <RevealOnScroll>
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-center text-gray-400 text-lg mb-12 max-w-2xl mx-auto">
            ...
            friendly chat. Feel free to reach out through any of these
            platforms!
          </p>
